...
<div style="font-family:Georgia,serif;max-width:600px;margin:0 auto;color:#111;line-height:1.6;">
  ...
  <table style="font-size:15px;border-collapse:collapse;width:100%;background:#f9f9f9;border:1px solid #eee;margin-bottom:10px;">
    ...
    : `<p style="font-size:15px;margin-top:0;">Your load-in window is:</p>
  <table style="font-size:15px;border-collapse:collapse;width:100%;background:#f9f9f9;border:1px solid #eee;margin-bottom:10px;">
    <tr>
      <td style="padding:12px 16px;color:#888;width:30%;">Load-In</td>
      <td style="padding:12px 16px;"><strong>${slot1Time}</strong></td>
    </tr>
  </table>`}
